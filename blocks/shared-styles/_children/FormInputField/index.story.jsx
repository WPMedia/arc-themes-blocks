...
export const textField = () => <FormInputField label="Plain Text Field" name="field1" />;

export const textFieldRequired = () => (
	<FormInputField label="Plain Text Field" name="field3" required showDefaultError />
);

export const textFieldPlaceholder = () => (
	<FormInputField label="Plain Text Field" name="field4" placeholder="Placeholder" />
);

export const textFieldTip = () => (
	<FormInputField label="Plain Text Field" name="field5" tip="Enter some text." />
);
