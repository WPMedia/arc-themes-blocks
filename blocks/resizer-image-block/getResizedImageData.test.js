...
describe('get resized image data helper on the server-side', () => {
  ...
  describe('when shouldCompressImageParams siteProperty is false (unset)', () => {
    ...
    it('resizes author bio if img available', () => {
      ...
      expect(by[0].resized_params).toEqual({
        '158x105':
          'jDV13NRbki-mzrsgQFfZjcSwABw=filters:format(jpg):quality(70)/',
        '158x119':
          'BTrRV2a2kh2y3BIwbM5oKQKBNDs=filters:format(jpg):quality(70)/',
        '274x183':
          'fxQaIWaQP5lRjwYUPWVQwMkNH9o=filters:format(jpg):quality(70)/',
        '274x206':
          'OL7VUs7AyKWyREepsXcuvd89l58=filters:format(jpg):quality(70)/',
      });
    });
    ...
    it('takes in lead art on the top level data', () => {
      ...
      expect(dataWithResizedImages.promo_items.lead_art.resized_params).toEqual(
        {
          '158x105':
            'I9PStk1gjBSf260jZTioN4u_RPo=filters:format(jpg):quality(70)/',
          '158x119':
            '-bLoWbHajT6EMnuJq9KILDWTk9k=filters:format(jpg):quality(70)/',
          '274x183':
            '3iOl2XDNsie7ZxxlpRagvADtkio=filters:format(jpg):quality(70)/',
          '274x206':
            'P5WszqbW7D4BknEyLhffQi2ulIk=filters:format(jpg):quality(70)/',
        },
      );
    });
    ...
    it('takes in search results data object', () => {
      ...
      expect(dataWithResizedImages[0].promo_items.basic.resized_params).toEqual(
        {
          '158x105':
            'OsfQnLmY00jrVTU2Bn4BNFUNMhU=filters:format(jpg):quality(70)/',
          '158x119':
            'h0EkN6oDSPYmLReOq22BJZYfCz4=filters:format(jpg):quality(70)/',
          '274x183':
            'tei84mHd537sfGdIxzgfEPb90rM=filters:format(jpg):quality(70)/',
          '274x206':
            '2Qa9_nYqKGnCzwL-goJs3iZ4LwY=filters:format(jpg):quality(70)/',
        },
      );
    });
