...
export const usingANSObject = () => {
  const props = {
    ...
    content: {
      headlines: {
        basic: text('headlines.basic', '7 questions about traveling to Australia during catastrophic fires, answered'),
      },
      websites: {
        'story-book': {
...
export const customLinkTextAndUrl = () => {
  const props = {
    ...
    linkClassName: text('linkClassName', ''),
    headingClassName: text('headingClassName', ''),
    text: text('text', '7 questions about traveling to Australia during catastrophic fires, answered'),
