...
describe("utils", () => {
	...
	it("ratesSingleUntilCancelled", () => {
		...
		expect(ratesSingleUntilCancelled("Week")).toBe(
			"checkout-block.rates-single-untilCancelled-week",
		);
		expect(ratesSingleUntilCancelled("Month")).toBe(
			"checkout-block.rates-single-untilCancelled-month",
		);
		expect(ratesSingleUntilCancelled("Year")).toBe(
			"checkout-block.rates-single-untilCancelled-year",
		);
