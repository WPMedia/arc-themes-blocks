...
describe('Form Password Confirm', () => {
  ...
  it('renders with tips', () => {
    ...
    expect(wrapper.find('div.xpmedia-form-field-tip').at(0).text().includes('Password Tip')).toBe(true);
    expect(wrapper.find('div.xpmedia-form-field-tip').at(1).text().includes('Confirm Tip')).toBe(true);
  });
  ...
  it('renders errors if showDefaultError', () => {
    ...
    expect(wrapper.find('div.xpmedia-form-field-tip').at(0).text().includes('Please enter something')).toBe(true);
    expect(wrapper.find('div.xpmedia-form-field-tip').at(1).text().includes('Must match password')).toBe(true);
  });
  ...
  it('renders errors if validation pattern is not met', () => {
    ...
    expect(wrapper.find('div.xpmedia-form-field-tip').at(0).text().includes('Please enter something good')).toBe(true);
  });
});
