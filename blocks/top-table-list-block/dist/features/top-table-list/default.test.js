...
describe('top table list', () => {
  ...
  it('renders null if no content', () => {
    ...
    const wrapper = (0, _enzyme.mount)( /*#__PURE__*/_react.default.createElement(TopTableList, {
      customFields: config,
      arcSite: "",
...
describe('default ratios', () => {
  ...
  it('must have a default 4:3 ratio for XL', () => {
    ...
    TopTableList.prototype.fetchContent = jest.fn().mockReturnValue({});
    const ttl = (0, _enzyme.mount)( /*#__PURE__*/_react.default.createElement(TopTableList, {
      customFields: xlConfig,
      arcSite: "",
      deployment: jest.fn(path => path)
    }));
