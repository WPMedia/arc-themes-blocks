const data = {
	...
	promo_items: {
		basic: {
			...
			additional_properties: {
				fullSizeResizeUrl:
					"/photo/resize/vw1sQ3cLpQq21AzJRls-usF5NMU=/arc-anglerfish-arc2-prod-corecomponents/public/ROWVW4VI5ZEJ7ISJNYEMVQ5YTE.png",
				galleries: [],
				...
				originalUrl:
					"https://cloudfront-us-east-1.images.arcpublishing.com/corecomponents/ROWVW4VI5ZEJ7ISJNYEMVQ5YTE.png",
				owner: "sara.carothers@washpost.com",
				proxyUrl:
					"/photo/resize/vw1sQ3cLpQq21AzJRls-usF5NMU=/arc-anglerfish-arc2-prod-corecomponents/public/ROWVW4VI5ZEJ7ISJNYEMVQ5YTE.png",
				published: true,
				resizeUrl:
					"http://thumbor-prod-us-east-1.photo.aws.arc.pub/vw1sQ3cLpQq21AzJRls-usF5NMU=/arc-anglerfish-arc2-prod-corecomponents/public/ROWVW4VI5ZEJ7ISJNYEMVQ5YTE.png",
				restricted: false,
				template_id: 297,
				thumbnailResizeUrl:
					"http://thumbor-prod-us-east-1.photo.aws.arc.pub/otY4xsB1W_mAYGxYZX3ZD9yz0tQ=/300x0/arc-anglerfish-arc2-prod-corecomponents/public/ROWVW4VI5ZEJ7ISJNYEMVQ5YTE.png",
				version: 4,
			},
			address: {},
			caption:
				"Mexican guitarist Cham\u00edn Correa performs 'La Barca' in a musical tribute to the Los Tres Caballeros, the musical trio he played in. Correa died at age 90.",
