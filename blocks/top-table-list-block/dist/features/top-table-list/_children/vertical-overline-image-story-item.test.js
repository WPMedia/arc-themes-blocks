...
describe('vertical overline image story item', () => {
  ...
  it('renders image and overline with full props', () => {
    ...
    const wrapper = (0, _enzyme.mount)( /*#__PURE__*/_react.default.createElement(VerticalOverlineImageStoryItem, sampleProps)); // doesn't show placeholder
  ...
  it('does not render image, overline and byline with empty props', () => {
    ...
    const wrapper = (0, _enzyme.mount)( /*#__PURE__*/_react.default.createElement(VerticalOverlineImageStoryItem, testProps)); // matches props
  ...
  it('renders VideoPlayer when type "story" with video lead art', () => {
    ...
    const wrapper = (0, _enzyme.shallow)( /*#__PURE__*/_react.default.createElement(VerticalOverlineImageStoryItem, testProps));
