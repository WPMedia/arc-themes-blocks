...
export const sectionWithNestedChildren = () => {
  ...
  return (
    <SectionTitle content={dataWithChildren} />
  );
};
...
export const sectionWithTripleNestedChildren = () => {
  ...
  return (
    <SectionTitle content={dataWithChildren2} />
  );
};
...
export const sectionWithNoChildren = () => {
  ...
  return (
    <SectionTitle content={dataWithNoChildren} />
  );
};
...
export const sectionWithNoTopLevelTitleWithChildren = () => {
  ...
  return (
    <SectionTitle content={dataWithNoName} />
  );
};
...
export const sectionTitleWithReallyLongName = () => {
  ...
  return (
    <SectionTitle content={dataWithReallyLongName} />
  );
};
