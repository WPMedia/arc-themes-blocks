...
describe('the promo label', () => {
  ...
  it('should not render when the promo type is missing', () => {
    const wrapper = (0, _enzyme.mount)( /*#__PURE__*/_react.default.createElement(_promo_label.default, null));
    expect(wrapper.find('div.promo-label').length).toBe(0);
    wrapper.unmount();
  });
  it('should not render when the promo type is "other"', () => {
    const wrapper = (0, _enzyme.mount)( /*#__PURE__*/_react.default.createElement(_promo_label.default, {
      type: "other"
    }));
    expect(wrapper.find('div.promo-label').length).toBe(0);
    wrapper.unmount();
  ...
  it('getLabelText should return null if no phrases passed ', () => {
    const result = (0, _promo_label.getLabelText)(null, 'type');
    expect(result).toBe(null);
  });
  it('getLabelText should return null if no type passed ', () => {
    const result = (0, _promo_label.getLabelText)({}, null);
    expect(result).toBe(null);
  });
  it('getLabelText should return null if type is not gallery nor video ', () => {
    const result = (0, _promo_label.getLabelText)({}, 'other');
    expect(result).toBe(null);
  });
