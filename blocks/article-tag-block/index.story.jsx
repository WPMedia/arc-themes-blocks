...
export const showAllFields = () => {
  const allData = data;
  return (
    <ArticleTagItems content={allData} arcSite="story-book" />
  );
};
...
export const noTags = () => {
  ...
  return (
    <ArticleTagItems content={noData} arcSite="story-book" />
  );
};
...
export const noDescription = () => {
  ...
  return (
    <ArticleTagItems content={noDescriptionFieldData} arcSite="story-book" />
  );
};
...
export const noSlug = () => {
  ...
  return (
    <ArticleTagItems content={noSlugFieldData} arcSite="story-book" />
  );
};
...
export const noText = () => {
  ...
  return (
    <ArticleTagItems content={noTextFieldData} arcSite="story-book" />
  );
};

export const manyTags = () => {
  const tenTags = Array(10).fill(0).map((x, i) => ({
    description: `tag ${i}`,
    slug: `tag-${i}`,
    text: `tag ${i} text`,
  }));
