...
describe('the subheadline feature for the default output type', () => {
  ...
  describe('when "includeSubHeadline" is set to true', () => {
  ...
  describe('when "includeSubHeadline" is set to false', () => {
    beforeEach(() => {
      jest.mock('fusion:context', () => ({
        useComponentContext: jest.fn(() => ({})),
      }));
    ...
    it('should render nothing', () => {
      const { default: SubHeadline } = require('./default');
      const wrapper = shallow(<SubHeadline customFields={{ includeSubHeadline: false }} />);

      expect(wrapper).toBeEmptyRender();
    });
  });

  describe('when "includeSubHeadline" is not set', () => {
    beforeEach(() => {
      jest.mock('fusion:context', () => ({
        useComponentContext: jest.fn(() => ({
          globalContent: {
    ...
    it('should render nothing', () => {
      const { default: SubHeadline } = require('./default');
      const wrapper = shallow(<SubHeadline customFields={{}} />);
